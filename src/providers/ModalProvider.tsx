...
export default function ModalProvider (): JSX.Element | null {
  ...
  return (
    <>
      ...
      <div className='fixed left-1/2 top-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-lg border border-slate-600 bg-slate-800 pb-4 pl-4 pr-6 pt-6'>
        <button

  ...
  return (
    <aside className='flex'>
      ...
      {selected !== Sidebar.Pokemon &&
        <div className='absolute bottom-0 top-12 z-10 w-full overflow-y-auto bg-slate-200 sm:top-16 md:static md:h-full md:w-72 lg:w-80 xl:w-96 dark:bg-slate-800'>
          {SIDE_BAR[selected]}
        </div>}
    </aside>
  )

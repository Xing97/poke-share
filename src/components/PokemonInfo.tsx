...
export default function PokemonInfo({ pokemon }: Props): JSX.Element {
  ...
  return (
    <div className="flex w-auto animate-fade-in flex-col gap-4 rounded-xl border border-slate-600 bg-slate-200 p-5 shadow-box animate-duration-slow dark:bg-slate-800">
